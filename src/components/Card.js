      ...
      <div className="content">
        ...
        >
          <div>
            ...
            <p>{_.capitalize(pokemon?.name) || "Devsuite"}</p>
          </div>
          <img
            alt="Devsuite"
            src={`https://media.gamestop.com/i/gamestop/11160869/Madcow-Entertainment-Pokemon-Snorlax-and-Pikachu-Light-Up-Statue?$pdp$${
              pokemon.id || 6
            }.png`}
          />
        </div>
